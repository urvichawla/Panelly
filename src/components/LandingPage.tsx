  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black px-4 py-10">
      <div className="max-w-2xl w-full text-center mb-12">
        <h1 className="text-5xl font-bold mb-6 text-white drop-shadow-lg animate-fadeIn" style={{ animationDelay: '0.1s' }}>
          Welcome to Panelly
        </h1>
        <p className="text-lg text-gray-300 mb-10 animate-fadeIn" style={{ animationDelay: '0.3s' }}>
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-neutral-900 rounded-2xl shadow-lg p-8 flex flex-col items-center border border-neutral-800 animate-slideUp" style={{ animationDelay: '0.7s' }}>
          <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2 animate-fadeIn" style={{ animationDelay: '0.8s' }}>
        ...
        {/* Candidate Features */}
        <div className="bg-neutral-900 rounded-2xl shadow-lg p-8 flex flex-col items-center border border-neutral-800 animate-slideUp" style={{ animationDelay: '1.0s' }}>
          <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2 animate-fadeIn" style={{ animationDelay: '1.1s' }}>
...
function FeatureCard({ icon, title, description, delay = 0 }: { icon: React.ReactNode; title: string; description: string; delay?: number }) {
  return (
    <div
      className="flex items-start gap-4 bg-neutral-800 rounded-xl p-4 border border-neutral-700 shadow-sm animate-slideUp"
